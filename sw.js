...
const CACHE = 'einkaufsfuchs-v0.8.1';
...
const SCHALE = [
    ...
    'favicon.ico?v=0.8.1',
    'icons/foxi.svg?v=0.8.1',
    'icons/favicon-64.png?v=0.8.1',
    'icons/icon-192.png?v=0.8.1',
    'icons/icon-512.png?v=0.8.1',
    'icons/maskable-512.png?v=0.8.1',
    'icons/apple-touch-icon.png?v=0.8.1'
];
